...
The `Medical Open Network for AI (MONAI) <https://project-monai.github.io/>`_ is a domain-optimized, open-source framework based on PyTorch, explicitly designed for deep learning in healthcare imaging. MONAI 1.5.2 on ROCm is a :doc:`HIP <hip:index>` port of `MONAI upstream version 1.5.2 <https://monai.readthedocs.io/en/stable/whatsnew_1_5_2.html>`_. It is API-compatible with upstream MONAI without requiring any code changes.
